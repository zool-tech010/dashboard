...
(function (e) {
            ...
            if ("absolute" === k && (c.hasClass(g.rightAlignClassName) || c.hasClass(g.leftAlignClassName) || "dt-container" === g.align)) {
                ...
                "absolute" === k
                    ? ((l = f.position()),
                      ...
                      c.css("left", c.position().left + o))
                    : ((k = c.height() / 2), k > e(r).height() / 2 && (k = e(r).height() / 2), c.css("marginTop", -1 * k));
    ...
    i.Api.register("buttons.exportData()", function (a) {
        if (this.context.length) {
            ...
            b.select && "function" === typeof b.select.info && g.selected === m && b.rows(c.rows, e.extend({ selected: !0 }, g)).any() && e.extend(g, { selected: !0 });
