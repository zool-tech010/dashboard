                    ...
                    e = (function () {
                        ...
                        return (
                            ...
                            Object.defineProperty(t.prototype, "opts", {
                                get: function () {
                                    return {
                                        ...
                                        line: { size: this.lineWidth, color: this.lineColor, cap: this.lineCap, join: this.lineJoin, miterLimit: this.lineMiterLimit },
                                    };
                                },
                                enumerable: !1,
                                configurable: !0,
                            ...
                            (t.prototype.toJSON = function () {
                                return { aspectRatio: this.canvas.width / this.canvas.height, strokes: this.strokes };
                            }),
                            ...
                            (t.prototype.drawLine = function (t, i, e) {
                                this.setOptions({ line: e }), (t = this.getPointRelativeToCanvas(new o(t.x, t.y))), (i = this.getPointRelativeToCanvas(new o(i.x, i.y))), this.pushStroke([t, i]), this.redraw();
                            }),
                            ...
                            (t.prototype.getPointRelativeToCanvas = function (t) {
                                return { x: t.x / this.canvas.width, y: t.y / this.canvas.height };
                            }),
                            ...
                            (t.prototype.setOptions = function (t) {
                                ...
                                t.backgroundColor && (this.backgroundColor = t.backgroundColor),
                                    (null === (i = t.line) || void 0 === i ? void 0 : i.size) && (this.lineWidth = t.line.size),
                                    (null === (e = t.line) || void 0 === e ? void 0 : e.cap) && (this.lineCap = t.line.cap),
                                    (null === (n = t.line) || void 0 === n ? void 0 : n.join) && (this.lineJoin = t.line.join),
                                    (null === (o = t.line) || void 0 === o ? void 0 : o.miterLimit) && (this.lineMiterLimit = t.line.miterLimit),
                            ...
                            (t.prototype.drawStroke = function (t) {
                                if (null != t.points) {
                                    ...
                                    this.ctx.closePath(),
                                        ...
                                        t.width && (this.ctx.lineWidth = this.normalizeLineWidth(t.width)),
                            ...
                            (t.prototype.pushStroke = function (t) {
                                this._strokes.push(s.fromObj({ points: t, size: this.getLineWidthRelativeToCanvas(this.lineWidth), color: this.lineColor, cap: this.lineCap, join: this.lineJoin, miterLimit: this.lineMiterLimit }));
                            }),
                            ...
                            (t.prototype.redraw = function () {
                                var t = this;
                                this.clearCanvas(),
                                    this._strokes.forEach(function (i) {
                    ...
                    s = (function () {
                        ...
                        return (
                            ...
                            (t.prototype.toObj = function () {
                                return { points: this.points, size: this.width, color: this.color, cap: this.cap, join: this.join, miterLimit: this.miterLimit };
                            }),
                            t
                        );
                    })();
